...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  HAL_GPIO_WritePin(GPIOG, LED_HEARTBEAT_Pin|LED_USER_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pins : LED_HEARTBEAT_Pin LED_USER_Pin */
  GPIO_InitStruct.Pin = LED_HEARTBEAT_Pin|LED_USER_Pin;
